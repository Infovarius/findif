...
eqs\[Phi]r[\[Lambda]_,\[Omega]_,\[Kappa]_,G_,Rn_]:={1/(Rn \[Rho]) \[Kappa] (-1/2 G Rn \[Rho]^2 Sin[\[Phi]] \[Psi][\[Rho],\[Phi]]+Sin[\[Phi]] 
...
RowBox[{"0", ",", "1"}], ")"}],
Derivative],
MultilineFunction->None]\)[\[Rho],\[Phi]])/4608+1/4 G Rn (-1+\[Rho]^2) Cos[\[Phi]] 
\!\(\*SuperscriptBox["\[Psi]", 
TagBox[
RowBox[{"(", 
RowBox[{"0", ",", "1"}], ")"}],
...
(* ::Input:: *)
(*Re/@GetIncrementsM[mat,{\[Kappa]->0.002,\[Omega]->0,G->4,\[Epsilon]->0,Re->300}]//Sort*)
...
(* ::Input:: *)
(*Short[ew=GetEigenWaveM[mat,5,5,{\[Kappa]->0.002,\[Omega]->0,G->4,\[Epsilon]->0,Re->300},4]//Chop,10]*)
...
(* ::Input:: *)
(*PrintRange[Transpose[{Range[0,\[Kappa]max,d\[Kappa]],Last/@incsRe100}]]*)
