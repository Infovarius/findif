...
double          dc1=c1-2825.0/27648.0,dc3=c3-18575.0/48384.0,
 ...
 enter++;
   ...
   for(i=ghost;i<mm1;i++)
   for(k=ghost;k<mm3;k++)
      fout[l][i][0][k] = f[l][i][0][k]+dt*b21*df1[l][i][0][k];
   ...
   for(i=ghost;i<mm1;i++)
   for(k=ghost;k<mm3;k++)
      fout[l][i][0][k] = f[l][i][0][k]+dt*(b31*df1[l][i][0][k]+
                                           b32*df2[l][i][0][k]);
   ...
   for(i=ghost;i<mm1;i++)
   for(k=ghost;k<mm3;k++)
      fout[l][i][0][k] = f[l][i][0][k]+dt*(b41*df1[l][i][0][k]+
                                           b42*df2[l][i][0][k]+
                                           b43*df3[l][i][0][k]);
   ...
   for(i=ghost;i<mm1;i++)
   for(k=ghost;k<mm3;k++)
      fout[l][i][0][k] = f[l][i][0][k]+dt*(b51*df1[l][i][0][k]+
                                           b52*df2[l][i][0][k]+
                                           b53*df3[l][i][0][k]+
                                           b54*df4[l][i][0][k]);
   ...
   for(i=ghost;i<mm1;i++)
   for(k=ghost;k<mm3;k++)
      fout[l][i][0][k] = f[l][i][0][k]+dt*(b61*df1[l][i][0][k]+
                                           b62*df2[l][i][0][k]+
                                           b63*df3[l][i][0][k]+
                                           b64*df4[l][i][0][k]+
                                           b65*df5[l][i][0][k]);
   ...
   for(k=ghost;k<mm3;k++)
   {
      fout[l][i][0][k] = f[l][i][0][k]+dt*(c1*df1[l][i][0][k]+
                                           c3*df3[l][i][0][k]+
                                           c4*df4[l][i][0][k]+
                                           c6*df2[l][i][0][k]);
      sca = fabs(f[l][i][0][k])+fabs(dt*df1[l][i][0][k])+MinScale;
      err1 = fabs(dt*(    dc1*df1[l][i][0][k]+
                          dc3*df3[l][i][0][k]+
                          dc4*df4[l][i][0][k]+
                          dc5*df5[l][i][0][k]+
                          dc6*df2[l][i][0][k]))/sca;
